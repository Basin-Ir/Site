...
(function() {
    ...
    function hb(h) {
        ...
        if (h.exportEnabled && h._dropdownMenu) {
            ...
            }), F.innerHTML = h._cultureInfo.printText, F.style.backgroundColor = h.toolbar.itemBackgroundColor, F.style.color = h.toolbar.fontColor, h._dropdownMenu.appendChild(F),
            ...
            F.innerHTML = h._cultureInfo.saveJPGText, F.style.backgroundColor = h.toolbar.itemBackgroundColor, F.style.color = h.toolbar.fontColor, h._dropdownMenu.appendChild(F), J(F, "touchstart", function(h) {
                m = !0
            }, h.allDOMEventHandlers), J(F, "mousemove", function() {
                m || (this.style.backgroundColor = h.toolbar.itemBackgroundColorOnHover, this.style.color = h.toolbar.fontColorOnHover)
            }, h.allDOMEventHandlers, !0), J(F, "mouseout", function() {
                ...
                padding: "12px 8px 12px 8px"
            }), F.innerHTML = h._cultureInfo.savePNGText, F.style.backgroundColor = h.toolbar.itemBackgroundColor, F.style.color = h.toolbar.fontColor, h._dropdownMenu.appendChild(F), J(F, "touchstart", function(h) {
                m = !0
            }, h.allDOMEventHandlers), J(F, "mousemove", function() {
    ...
    function xa(h, m, r) {
        ...
        m.getAttribute("state") !==
            r && (m.setAttribute("state", r), m.setAttribute("type", "button"), V(m, {
                ...
                lineHeight: "0"
            }), m.setAttribute("title", h._cultureInfo[r + "Text"]), m.innerHTML = "<img src='" + kb[r].image + "' alt='" + h._cultureInfo[r + "Text"] + "' />", V(m.childNodes[0], {
                height: "95%",
                pointerEvents: "none"
            }))
    }
